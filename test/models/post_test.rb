...
class PostTest < ActiveSupport::TestCase
  ...
  test "Posts are in descending order" do
    ...
    post_3 = Post.create(title: "first title", content: "first content", created_at: 10.minutes.ago, user: @user)
    post_1 = Post.create(title: "third title", content: "third content", created_at: 3.minutes.ago, user: @user)
    post_2 = Post.create(title: "second title", content: "second title", created_at: 5.minutes.ago, user: @user)
 ...
 test "Posts have users validations" do
  ...
  post_1 = Post.new(title: "third title", content: "third content", created_at: 3.minutes.ago, user: @user)
  assert post_1.valid?
